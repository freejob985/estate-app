          <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        <a href="<?php echo e(route('properties.create')); ?>" aria-expanded="false" class="dropdown-toggle autodroprown">
                            <div class="">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-database"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path></svg>                                <span>اضافة عقار</span>
     ...
     <li class="menu single-menu">
                        <a href="<?php echo e(route('properties.index')); ?>" aria-expanded="false" class="dropdown-toggle autodroprown">
                            <div class="">
...
<?php if(Auth::user()->remember_token=="1"): ?>



     <li class="menu single-menu">
                        <a href="<?php echo e(route('properties.export')); ?>" aria-expanded="false" class="dropdown-toggle autodroprown">
                            <div class="">
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zoom-in"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg>                                <span>  البحث</span>
     ...
     <li class="menu single-menu">
                        <a href="<?php echo e(route('properties.import.view')); ?>" aria-expanded="false" class="dropdown-toggle autodroprown">
                            <div class="">
...
<?php if(Auth::user()->remember_token=="1"): ?>
     ...
     <li class="menu single-menu">
                        <a href="<?php echo e(route('users.index')); ?>" aria-expanded="false" class="dropdown-toggle autodroprown">
                            <div class="">
...
<?php endif; ?>
     ...
     <li class="menu single-menu">
                        <a href="<?php echo e(route('logout.app')); ?>" aria-expanded="false" class="dropdown-toggle autodroprown">
                            <div class="">
...
<?php /**PATH D:\server\htdocs\estate-app\resources\views/menu-categories.blade.php ENDPATH**/ ?>